...
type PaymentRequest struct {
	...
	CreditCardd *CreditCardd `protobuf:"bytes,1,opt,name=CreditCardd,proto3" json:"CreditCardd,omitempty"`
	Amount      float64      `protobuf:"fixed64,2,opt,name=amount,proto3" json:"amount,omitempty"`
	Store       string       `protobuf:"bytes,3,opt,name=store,proto3" json:"store,omitempty"`
	Descritpion string       `protobuf:"bytes,4,opt,name=descritpion,proto3" json:"descritpion,omitempty"`
}
...
func (x *PaymentRequest) GetCreditCardd() *CreditCardd {
	if x != nil {
		return x.CreditCardd
	}
	return nil
}
...
func (x *PaymentRequest) GetDescritpion() string {
	if x != nil {
...
func (x *CreditCardd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreditCardd) ProtoMessage() {}

func (x *CreditCardd) ProtoReflect() protoreflect.Message {
	mi := &file_protofile_payment_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreditCardd.ProtoReflect.Descriptor instead.
func (*CreditCardd) Descriptor() ([]byte, []int) {
	return file_protofile_payment_proto_rawDescGZIP(), []int{1}
}

func (x *CreditCardd) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreditCardd) GetNumber() string {
	if x != nil {
		return x.Number
	}
	return ""
...
func (x *CreditCardd) GetExpirationMonth() int32 {
	if x != nil {
...
func (x *CreditCardd) GetExpirationYear() int32 {
	if x != nil {
...
func (x *CreditCardd) GetCvv() int32 {
	if x != nil {
		return x.Cvv
	}
	return 0
...
var file_protofile_payment_proto_rawDesc = []byte{
	...
	,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x09, 0x5a, 0x07, 0x67, 0x72, 0x70, 0x63,
...
var file_protofile_payment_proto_goTypes = []interface{}{
	...
	(*CreditCardd)(nil),    // 1: payment.CreditCardd
	(*empty.Empty)(nil),    // 2: google.protobuf.Empty
}
var file_protofile_payment_proto_depIdxs = []int32{
	1, // 0: payment.PaymentRequest.CreditCardd:type_name -> payment.CreditCardd
